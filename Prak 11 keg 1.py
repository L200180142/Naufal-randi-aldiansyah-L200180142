...
L3 = Label(my_app, text="Naufal Randi Aldiansyah")
L3.grid(row=1, column=1)
L4 = Label(my_app, text="NIM")
L4.grid(row=2, column=0)
L5 = Label(my_app, text="L200180142")
L5.grid(row=2, column=1)
L6 = Label(my_app, text="Buku favorit")
L6.grid(row=3, column=0)
L7 = Label(my_app, text="5 cm")
L7.grid(row=3, column=1)
L8 = Label(my_app, text="Hibby")
L8.grid(row=4, column=0)
L9 = Label(my_app, text="Nonton film")
L9.grid(row=4, column=1)
L10 = Label(my_app, text="Motto")
L10.grid(row=5, column=0)
L11 = Label(my_app, text="Jadilah diri sendiri, dan lakukan yang terbaik")
